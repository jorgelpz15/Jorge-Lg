...
export function inyectarEstiloGlobal() {
  ...
  ss.textContent = `*{box-sizing:border-box;-webkit-tap-highlight-color:transparent}body{margin:0;background:#000;overscroll-behavior:none}input::placeholder{color:#555}button:active{transform:scale(0.97)}input:focus{border-color:#ffd700 !important;box-shadow:0 0 0 3px rgba(255,215,0,0.2)}::-webkit-scrollbar{width:4px}::-webkit-scrollbar-track{background:transparent}::-webkit-scrollbar-thumb{background:#333;border-radius:2px}`;
