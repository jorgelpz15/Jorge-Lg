...
export default function LobbyPontePedo({ uid, onEntrar, onVolverAlMenu }) {
    ...
    <div style={S.page}>
      <div style={{ maxWidth: 380, width: "100%" }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 900, color: "#fff", margin: 0 }}>Ponte Pedo</h1>
          <p style={{ color: "#7a7a7a", fontSize: 12, marginTop: 8 }}>saca una carta y todos ven qué reto les toca</p>
        </div>
  ...
  if (pantalla === "crear") return (
    <div style={{ ...S.page, justifyContent: "flex-start", padding: "36px 20px" }}>
      ...
      <label style={S.fieldLabel} htmlFor="nombre-crear-pp">Tu nombre</label>
      <input id="nombre-crear-pp" style={{ ...S.input, width: "100%", marginBottom: 16 }} placeholder="Ej. Jorge" value={nombre}
  ...
  if (pantalla === "unir") return (
    <div style={{ ...S.page, justifyContent: "flex-start", padding: "36px 20px" }}>
      ...
      <label style={S.fieldLabel} htmlFor="nombre-unir-pp">Tu nombre</label>
      <input id="nombre-unir-pp" style={{ ...S.input, width: "100%", marginBottom: 12 }} placeholder="Ej. Jorge" value={nombre}
        onChange={(e) => setNombre(e.target.value)} maxLength={12} />
      <label style={S.fieldLabel} htmlFor="codigo-unir-pp">Código de la sala</label>
      <input id="codigo-unir-pp" style={{ ...S.input, width: "100%", marginBottom: 16, fontSize: 24, letterSpacing: 6, textAlign: "center" }}
